...
export default function SalesConversation() {
  ...
  return (
    <div className="container grid px-6 mx-auto">
      ...
      <a className=" w-full flex align-middle items-center  p-4 mb-8 text-sm font-semibold overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-bluesecundary scrollbar-track-transparent text-purple-100 bg-blueground rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple ">
