    ...
    <>
      <aside className="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
        <div className="py-4 text-gray-500 dark:text-gray-400">
          <Link className="ml-6 flex align-middle text-gray-800 dark:text-gray-200" to="/">
          ...
          <ul className="mt-6">
            <li className="relative px-6 py-3">
              ...
              >
                <svg
                  className="w-5 h-5 text-blueground"
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
          ...
          <ul>
            <li className="relative px-6 py-3">
              ...
              >
                ...
                <svg className="w-4 h-4" fill="var(--blueground)" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
              ...
              {data.pagesMenuOpen && sideMenuName == "menu-conversion" && (
                ...
                >
                  ...
                  <li className="px-2 py-1 hover:text-gray-800 dark:hover:text-gray-200">
                    <Link to="/app/conversation">Agenda Google</Link>
                  </li>
                  <li className="px-2 py-1 hover:text-gray-800 dark:hover:text-gray-200">
                    <Link to="/app/conversation">Fluxo de Pedidos</Link>
                  </li>
                  <li className="px-2 py-1 hover:text-gray-800 dark:hover:text-gray-200">
                    <Link to="/app/conversation">Emails</Link>
                  </li>
                  <li className="px-2 py-1 hover:text-gray-800 dark:hover:text-gray-200">
                    <Link to="/app/conversation">Campanhas</Link>
                  </li>
                  <li className="px-2 py-1 hover:text-gray-800 dark:hover:text-gray-200">
                    <Link to="/app/conversation">Relatorios</Link>
                  </li>
                </ul>
              )}
            </li>
